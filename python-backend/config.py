...
AI_CONFIGS = {
    ...
    "groq": {
        ...
        "models": [
            ...
            {"id": "qwen-qwq-32b",              "name": "Qwen QwQ 32B",         "tier": "free"},
            {"id": "deepseek-r1-distill-llama-70b", "name": "DeepSeek R1 70B",  "tier": "free"},
        ],
        "defaultModel": "__auto__",
    ...
    "gemini": {
        ...
        "models": [
            {"id": "__auto__",                       "name": "Auto — Best Available",  "tier": "free"},
            {"id": "gemini-2.5-flash-preview-04-17", "name": "Gemini 2.5 Flash",      "tier": "free"},
            ...
            {"id": "gemini-2.5-pro-preview-03-25",   "name": "Gemini 2.5 Pro",        "tier": "plus"},
        ],
        "defaultModel": "__auto__",
        "freeModel":    "gemini-2.5-flash-preview-04-17",
    },
    "openrouter": {
        "id": "openrouter",
        "name": "OpenRouter",
    ...
    "claude": {
        ...
        "models": [
            {"id": "__auto__",                   "name": "Auto — Best Available",         "tier": "free"},
            {"id": "claude-3-5-haiku-20241022",  "name": "Claude 3.5 Haiku (Free, Fast)", "tier": "free"},
            {"id": "claude-3-5-sonnet-20241022", "name": "Claude 3.5 Sonnet (Free)",      "tier": "free"},
            {"id": "claude-3-7-sonnet-20250219", "name": "Claude 3.7 Sonnet (Pro)",       "tier": "plus"},
        ],
        "defaultModel": "__auto__",
