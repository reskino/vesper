...
AI_CONFIGS = {
    ...
    "groq": {
        ...
        "models": [
            ...
            {"id": "mixtral-8x7b-32768",      "name": "Mixtral 8×7B",   "tier": "free"},
    ...
    "openrouter": {
        ...
        "models": [
            {"id": "meta-llama/llama-4-scout:free",              "name": "Llama 4 Scout (free)",         "tier": "free"},
            {"id": "meta-llama/llama-4-maverick:free",           "name": "Llama 4 Maverick (free)",      "tier": "free"},
        ...
        "freeModel":    "meta-llama/llama-4-scout:free",
    },
    "mistral": {
        "id": "mistral",
        "name": "Mistral AI",
