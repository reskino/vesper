...
AI_CONFIGS = {
    ...
    "claude": {
        ...
        "models": [
            ...
            {"id": "claude-haiku-4-5",           "name": "Claude Haiku 4.5 (Pro)",         "tier": "plus"},
            {"id": "claude-sonnet-4-5",          "name": "Claude Sonnet 4.5 (Pro)",        "tier": "plus"},
            {"id": "claude-opus-4-5",            "name": "Claude Opus 4.5 (Max)",          "tier": "pro"},
        ],
        "defaultModel": "__auto__",
