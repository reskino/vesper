...
AI_CONFIGS = {
    ...
    "openrouter": {
        ...
        "models": [
            ...
            {"id": "openai/gpt-oss-120b:free",                         "name": "OpenAI GPT OSS 120B (free)",    "tier": "free"},
            {"id": "openai/gpt-oss-20b:free",                          "name": "OpenAI GPT OSS 20B (free)",     "tier": "free"},
            {"id": "google/gemma-4-31b-it:free",                       "name": "Gemma 4 31B (free)",            "tier": "free"},
            {"id": "google/gemma-3-27b-it:free",                       "name": "Gemma 3 27B (free)",            "tier": "free"},
            {"id": "qwen/qwen3-coder:free",                            "name": "Qwen3 Coder 480B (free)",       "tier": "free"},
            {"id": "qwen/qwen3-next-80b-a3b-instruct:free",            "name": "Qwen3 Next 80B (free)",         "tier": "free"},
            {"id": "nvidia/nemotron-3-super-120b-a12b:free",           "name": "NVIDIA Nemotron 3 Super (free)", "tier": "free"},
            {"id": "nousresearch/hermes-3-llama-3.1-405b:free",        "name": "Hermes 3 405B (free)",          "tier": "free"},
            {"id": "minimax/minimax-m2.5:free",                        "name": "MiniMax M2.5 (free)",           "tier": "free"},
