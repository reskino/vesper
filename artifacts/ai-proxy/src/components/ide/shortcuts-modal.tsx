...
const SHORTCUT_GROUPS: ShortcutGroup[] = [
  {
    ...
    shortcuts: [
      { keys: ["Ctrl", "P"],       label: "Open file search" },
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: ["Ctrl", "F"],       label: "Find in file (Monaco)" },
      { keys: ["Ctrl", "/"],       label: "Toggle line comment (Monaco)" },
    ],
  },
  {
    title: "Panels & Chat",
  ...
  {
    title: "Right-click (Tab)",
    shortcuts: [
      { keys: ["Right-click tab"], label: "Close / Close Others / Close All / Copy Path" },
    ],
  },
];
