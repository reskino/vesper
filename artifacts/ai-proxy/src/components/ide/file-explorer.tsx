    ...
    <div className="flex flex-col h-full bg-[#0a0a0c]">
      ...
      <div className="hidden md:flex items-center justify-between px-2 py-2 border-b border-[#1a1a24] shrink-0">
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="h-5 w-5 flex items-center justify-center rounded text-[#7878a8] hover:text-[#a0a0c0] hover:bg-[#141420] transition-colors"
        ...
        <div className="flex items-center gap-0.5">
          {[
            ...
            <button key={title}
              className="h-5 w-5 flex items-center justify-center rounded text-[#9898b8] hover:text-[#a0a0c0] hover:bg-[#141420] transition-colors last:hover:text-red-400"
      ...
      <div className="md:hidden flex flex-col gap-2.5 px-3 pt-3 pb-2 border-b border-[#1a1a24] shrink-0">
        ...
        <div className="relative">
          ...
          {searchQuery && (
            <button
              className="absolute right-3 top-1/2 -translate-y-1/2 text-[#9898b8] active:text-foreground"
      ...
      {newItem && (
        <div className="px-2 py-1.5 border-b border-[#1a1a24] shrink-0 bg-[#0d0d12]">
          ...
          <div className="flex gap-1">
            ...
            <button
              className="h-6 px-1.5 text-xs border border-[#1a1a24] rounded hover:bg-[#141420] text-[#9898b8] transition-colors"
